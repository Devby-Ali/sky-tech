...
export default function Ticket() {
  return (
    <main className="pb-5 md:pb-8 mx-auto mt-6 md:mt-12">
      ...
      <Link className="flex items-center justify-between gap-x-3 w-full sm:w-auto md:w-full lg:w-auto xl:w-96 text-2xl sm:text-[1.6rem] text-teal-300 bg-transparent border border-teal-300 h-24 sm:h-[8.8rem] md:h-[6.9rem] px-5 lg:px-7 font-EstedadBold rounded-lg" to="send-ticket">
          ارسال تیکت جدید
