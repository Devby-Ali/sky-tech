        ...
        <div className="bg-white dark:bg-darkBox p-9 rounded-md text-darkColor dark:text-white">
          <div className="flex items-center justify-between gap-7 flex-wrap mb-9 pb-9 border-b border-b-neutral-200 dark:border-b-white/10">
            <span className="text-[1.7rem] sm:text-3xl font-EstedadMedium">
              #۱۱۶۸۵ دسترسی به فایل فیگما مینی پروژه ها
            </span>
            <div className="flex items-center gap-x-1.5 text-2xl sm:text-[1.7rem] text-green-500 shrink-0 mr-auto">
              <div className="text-4xl">
               <HiOutlineCheckCircle />
              </div>
              <span className="font-EstedadMedium">بسته شده</span>
            </div>
          </div>

          <div className="space-y-9 md:space-y-12 md:pt-2 mb-16 md:mb-25">
            <div className="w-full lg:w-1/2 text-darkBox dark:text-white/90 bg-light-blue-50 dark:bg-[#333c4c] p-8 rounded-md">
              <p className="text-2xl md:text-[1.7rem]">ali080bakhshi@gmail.com</p>
