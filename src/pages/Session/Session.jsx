    ...
    <>
      ...
      <main className="max-w-[1920px] mx-auto overflow-x-hidden pt-12 lg:pt-52 2xl:pt-56">
        <div className="container">
          ...
          <div className="grid grid-cols-12 gap-y-6 gap-x-5 lg:gap-x-7 mt-8 lg:mt-8 text-darkColor dark:text-white">
          ...
          >
            ...
            <div className="mb-8 pb-8 border-b border-b-neutral-200 dark:border-b-white/10">
              ...
              <div className="dark:text-gray-400">
                ...
                اینکه سوالی بپرسید، با دقت و تمرکز سعی کنید مشکل رو خودتون حل
                کنید. اگه به جواب نرسیدید، می‌تونید از گوگل کمک بگیرید. اگه با
                خطایی مواجه شدید یا نیاز به نمونه‌ای داشتید، با استفاده از کلمات
                کلیدی مختلف توی گوگل سرچ کنید و از سایت‌هایی مثل Stack Overflow
                کمک بگیرید. (جواب 99٪ سوالات با این روش زیر 5 دقیقه پیدا میشه)
                <br />
                از پرسیدن سوالات کلی مثل «من مثل شما انجام دادم ولی کار نکرد» یا
                «کد من مشکل داره و اجرا نمیشه» که جزئیات ندارن، خودداری کنید.
                وقتی سوال می‌پرسید، لطفاً اون رو با مستندات و به صورت شفاف و
                واضح بیان کنید تا قابل تحلیل و بررسی باشه. سعی کنید سوالاتتون
                مفهومی و دقیق باشه تا مکالمه‌ای که دارید خلاصه و مفید باشه.
                همچنین قبل از اینکه سوال ارسال کنید، یه بار خودتون اون رو بخونید
                و مطمئن بشید که سوالتون خوانا و واضحه.
              </div>
              <h5 className="font-danaBold mb-3 mt-6">
                چه انتظاراتی از پشتیبانان باید داشته باشم؟
              </h5>
              <div className="dark:text-gray-400">
                از مدرسین و پشتیبانان انتظارات منطقی و مرتبط با خدمات دریافتی
                خود داشته باشید. حل مشکلات خارج از مباحث و پروژه های دوره در
                حیطه وظایف پشتیبانان/مدرسین نیست. اگر نیاز به مشاوره دارید
            ...
            <div className="mb-8 sm:mb-10">
              ...
              <div className="flex items-center gap-x-2 text-red-500 mb-4">
                ...
                <p className="text-sm md:font-danaMedium">
                  لطفا قبل از ثبت پرسش بالاتر بخش قوانین ایجاد سوال را مطالعه
                  کنید.
                </p>
              </div>
              ...
              <form id="attachments_form" className="hidden">
                ...
                <input type="hidden" name="exts" value="zip,rar,png,jpg,jpeg" />
        ...
        <aside className="col-span-full order-first md:order-none md:col-span-5 xl:col-span-4">
          ...
          <div className="bg-white dark:bg-darkBox p-4.5 sm:p-5 text-center rounded-lg mt-6 lg:mt-8">
            ...
            <a target="_blank" href="/" className="w-full btn btn-secondary">
              دانلود
            </a>
          </div>
        </aside>
