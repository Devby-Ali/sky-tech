  ...
  return (
    <div className="my-24">
      <div className="container">
        ...
        <div className="grid grid-rows-2 md:grid-cols-2 gap-2 cursor-default">
          <AboutUsBox
          ...
          <AboutUsBox
            ...
            icon={<MdOutlineContentCopy className="text-fuchsia-600/80" />}
          />
          <AboutUsBox
            ...
            icon={<GiCutDiamond className="text-lightishBlue-500" />}
          />
          <AboutUsBox
            ...
            icon={<IoCodeWorking className="text-emerald-500/90" />}
          />
        </div>
      </div>
    </div>
