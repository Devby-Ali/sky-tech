...
export default function Landing() {
  return (
    <section className="text-center pt-48 lg:pt-64 pb-24 text-white">
      <div className="container">
        <div className="lg:flex lg:flex-row-reverse gap-x-16">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="hidden lg:flex justify-evenly items-center w-[60rem] mt-16 child:w-3/4">
              <div className="flex-center flex-col text-white">
                ...
                <span className="font-bold">کاربر ثبت نام کردن</span>
              </div>
              ...
              <div className="flex-center flex-col text-white">
                ...
                <span className="font-bold">دوره آموزشی داریم</span>
              </div>
              ...
              <div className="flex-center flex-col text-white">
                ...
                <span className="font-bold">دقیقه آموزش تولید کردیم</span>
              </div>
            </div>
          </div>
        </div>
