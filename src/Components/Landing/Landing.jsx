...
export default function Landing({ info }) {
  ...
  return (
    <section className="relative bg-landing h-[48vh] sm:h-[60vh] lg:h-[72vh] xl:h-[90vh] overflow-hidden">
      <div
      ...
      <header className="md:flex max-w-[140rem] justify-between items-center w-full md:w-[95%] md:mx-auto">
        <div className="w-full h-full">
          <div className="h-full flex items-center justify-between px-12 py-4 md:py-8">
            ...
            <div className="flex gap-x-6 xl:gap-x-14">
              <Link to={"/"} className="text-light-blue-300 mb-1 2xl:mb-0">
                <svg
              ...
              <ul className="hidden md:flex gap-x-7 xl:gap-x-12 text-white text-[1.7rem] xl:text-[1.8rem] font-EstedadMedium dark:font-EstedadLight">
      ...
      <div className="flex-center h-[70%] mt-6 sm:mt-16 lg:mt-0">
        <div className="container text-center text-white">
          ...
          <div className="px-6 md:px-0">
            <div className="max-w-[700px] mt-16 sm:mt-20 lg:mt-24 mx-auto">
              <form
                className="flex items-center backdrop-blur-[7px] justify-between border-2 dark:border border-white/15 rounded-md py-4 sm:h-24 pl-4 sm:pl-7 pr-8"
                action="#"
              >
                <Input
                  type="text"
          ...
          <div className="flex px-10 sm:px-20 md:px-0 max-w-[65rem] mx-auto justify-between items-center mt-20 lg:mt-24 child:text-white/60">
            <div className="flex-center flex-col">
              ...
              <span className="text-2xl sm:text-3xl font-EstedadBold mt-2 sm:mt-4">
                کاربر ثبت نام کردن
              </span>
            </div>
